        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="md:col-span-2">
            ...
            <input
              ...
              required
              disabled={isLoading}
              className="w-full bg-white/15 border border-white/20 rounded-xl px-5 py-4 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-green-400/50 transition-all shadow-inner disabled:opacity-50"
            />
          </div>
