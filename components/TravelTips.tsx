...
import TravelpayoutsWidget from "./widgets/TravelpayoutsWidget";
...
export default function TravelTips({
  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="glass-card p-6 border-l-4 border-green-500">
            ...
            <div className="space-y-4 text-gray-200 text-sm leading-relaxed">
              <p>
                <strong>Wiza i dokumenty:</strong>{" "}
                {tips.before_you_go.visa_docs}
              </p>
              <p>
            ...
            <div className="space-y-3 text-gray-200 text-sm leading-relaxed">
              ...
              <div className="bg-white/5 p-3 rounded-lg">
                ...
                <ul className="list-disc ml-4 text-xs space-y-1">
                  {tips.finances.example_prices.map((price, index) => (
      ...
      {/* Widget Travelpayouts na samym końcu */}
      {cityName && countryName && (
        <div className="mt-10">
          <TravelpayoutsWidget cityName={cityName} countryName={countryName} />
        </div>
      )}
    </>
  );
